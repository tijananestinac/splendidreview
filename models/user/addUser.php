<?php
    ...
    if(isset($_POST['send'])){
        ...
        /*if(!preg_match($reUloga,$uloga)){
            array_push($greske, "Role can be 1(admin) or 2(user)");
        }*/ 
        ...
        if(count($greske)){
            ...
            $upit = "INSERT INTO user (idUser, first_name, last_name, email, password, idWebsiteRole) VALUES (NULL, :first_name, :last_name, :email, :password , :role)";
